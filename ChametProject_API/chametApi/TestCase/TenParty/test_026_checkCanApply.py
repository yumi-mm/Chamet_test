...
@allure.story('校验是否能够申请上麦位')
class Test_CheckCanApply(object):
    ...
    def test_CheckCanApply(self, caseData):
        time.sleep(1)
        user_type = 'audience'
        allLogin(user_type)
        # 从文件中读取bizCode值
        ...
        # 断言是否能够申请上麦位
        assert returnValue['info']['canApply'] == 1


if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_026_checkCanApply.py'])