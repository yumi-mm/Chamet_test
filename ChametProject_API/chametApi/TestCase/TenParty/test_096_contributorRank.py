...
@allure.story('本场贡献榜')
class Test_ContributorRank(object):
    ...
    def test_ContributorRank(self, caseData):
        time.sleep(1)
        user_type = 'audience'
        allLogin(user_type)
        # 从文件中读取bizCode值
        ...
        # 目标用户id为2000004
        assert returnValue['info']['toUserInfo']['userid'] == 2000004

if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_096_contributorRank.py'])