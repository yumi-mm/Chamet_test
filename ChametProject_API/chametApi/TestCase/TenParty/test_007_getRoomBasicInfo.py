...
@allure.story('直播间基本信息')
class Test_GetRoomBasicInfo(object):
    ...
    def test_GetRoomBasicInfo(self, caseData):
        time.sleep(1)
        user_type = 'anchor'
        allLogin(user_type)
        # 从文件中读取bizCode值
        ...
        # 断言是否为房主
        assert returnValue['info']['type'] == 1

if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_007_getRoomBasicInfo.py'])