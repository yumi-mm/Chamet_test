...
@allure.story('直播间多人隔离榜列表')
class Test_ListIsolationMultiRoom(object):
    ...
    def test_ListIsolationMultiRoom(self, caseData):
        time.sleep(1)
        user_type = 'anchor'
        allLogin(user_type)
...
if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_063_listIsolationMultiRoom.py'])
