...
@allure.story('礼物列表详情')
class Test_QueryGiftsListByPage(object):
    ...
    def test_QueryGiftsListByPage(self, caseData):
        time.sleep(1)
        user_type = 'audience'
        allLogin(user_type)
        ...
        # 断言礼物列表个数等于4
        assert returnValue['info']['totalCount'] == 4

if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_087_queryGiftsListByPage.py'])
