...
@allure.story('校验是否需要展示直播引导消息')
class Test_CheckShowLiveGuide(object):
    ...
    def test_CheckShowLiveGuide(self, caseData):
        time.sleep(1)
        user_type = 'anchor'
        allLogin(user_type)
...
if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_068_checkShowLiveGuide.py'])
