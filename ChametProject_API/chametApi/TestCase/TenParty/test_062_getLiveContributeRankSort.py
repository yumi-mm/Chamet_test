...
@allure.story('获取直播间贡献榜排名')
class Test_GetLiveContributeRankSort(object):
    ...
    def test_GetLiveContributeRankSort(self, caseData):
        time.sleep(1)
        user_type = 'anchor'
        allLogin(user_type)
        # 从文件中读取bizCode值
...
if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_062_getLiveContributeRankSort.py'])
