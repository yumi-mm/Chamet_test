...
@allure.story('获取直播间统计信息')
class Test_GetRoomStatisticInfo(object):
    ...
    def test_GetRoomStatisticInfo(self, caseData):
        time.sleep(1)
        user_type = 'anchor'
        allLogin(user_type)
        # 从文件中读取bizCode值
...
if __name__ == '__main__':
    pytest.main(['-s', '-v', 'test_008_getRoomStatisticInfo.py'])