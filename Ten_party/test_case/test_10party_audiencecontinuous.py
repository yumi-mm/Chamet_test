from common.partytencommon.party_Start_audiencecontinuous import partyaudiencecontinuous_Start_End
...
class Test_chamet(partyaudiencecontinuous_Start_End):
    which_party = 0
    ...
    def test_TenParty_038(self):
        ...
        try:
            self.partyten.audience_usermessage_sendtext("hello")
    ...
    '''
    pytest .\test_10party_audiencecontinuous.py -v -s --alluredir=..\result\2023_6_9_016
    pytest --lf .\test_10party_audience.py -v -s --alluredir=..\result\2023_6_13_002
    allure serve  ..\result\2023_6_9_016
    pytest -s -v test_10party_audiencecontinuous.py::Test_chamet::test_TenParty_013
    '''
