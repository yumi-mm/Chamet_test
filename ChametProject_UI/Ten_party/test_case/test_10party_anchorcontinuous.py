from common.partytencommon.party_Start_continuous import party_Start_End_continuous
...
class Test_chamet(party_Start_End_continuous):
    ...
    def test_TenParty_049(self):
        ...
        try:
            ...
            self.driver.back()
            self.partyten.touch_tap(300,440)
    ...
    '''
    pytest .\test_10party_anchorcontinuous.py -v -s --alluredir=..\result\2023_6_18_001
    pytest --lf .\test_10party_audience.py -v -s --alluredir=..\result\2023_6_13_002
    allure serve  ..\result\2023_6_9_016
    pytest -s -v test_10party_anchorcontinuous.py::Test_chamet::test_TenParty_013
    '''
