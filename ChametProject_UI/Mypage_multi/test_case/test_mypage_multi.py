...
class Test_multi_mypage(mypage_multi_Start_End):
    ...
    def test_homepage01(self):
        ...
        try:
            ...
            global newName
            newName = 'Tom33364388eee'
            global newIntro
            newIntro = 'oh!happy every 1 eee'
    ...
    def test_homepage10(self):
        ...
        try:
            if followers_num!=False and int(followers_num)>0:
                ...
                # followers_firstName = self.mandriver.find_elements(*MultiMan.user_followers_firstPerNameID)[0].text.encode("utf-8")
                ...
                # assert self.mandriver.find_elements(*MultiMan.user_followers_firstPerNameID)[0].text.encode("utf-8")==followers_firstName.encode("utf-8")
                self.multiman.swipe(340, 1836, 340, 800)
                time.sleep(3)
                # assert self.mandriver.find_elements(*MultiMan.user_followers_firstPerNameID)[0].text.encode("utf-8") != followers_firstName
                # assert self.mandriver.find_elements(*MultiMan.user_followers_firstPerNameID)[0].text.encode('gbk', 'ignore') != followers_firstName
                # 检查国家、状态、等级元素有无
    ...
    def test_homepage11(self):
        ...
        try:
            if followers_num!=False and int(followers_num)>0:
                ...
                # followers_firstPerName=self.mandriver.find_elements(*MultiMan.user_followers_firstPerNameID)[0].text.encode("utf-8")
                ...
                # assert self.mandriver.find_element(*MultiMan.user_own_pagePersonalName).text.encode("utf-8") == followers_firstPerName
                self.mandriver.find_element(*MultiMan.user_own_pageGobackBtn).click()
    ...
    def test_homepage14(self):
        ...
        try:
            if following_num!=False and int(following_num)>0:
                ...
                time.sleep(2)
                assert self.mandriver.find_element(*MultiMan.user_own_pagePersonalName)
                # assert self.mandriver.find_element(*MultiMan.user_own_pagePersonalName).text.encode("utf-8") == following_firstPerName
    ...
    def test_homepage16(self):
        ...
        try:
            if friend_num!=False and int(friend_num)>0:
                # 上下滑动
                # friend_firstName = self.mandriver.find_elements(*MultiMan.user_friend_firstPerNameID)[0].text.encode("utf-8")
                ...
                time.sleep(3)
                # assert self.mandriver.find_elements(*MultiMan.user_friend_firstPerNameID)[0].text.encode("utf-8") == friend_firstName
    ...
    def test_homepage18(self):
        ...
        try:
            ...
            if signInfoTopEle_man != False:
                ...
                self.mandriver.find_element(*MultiMan.sign_in_popover_reminderBtn).click()
    ...
    def test_homepage20(self):
        ...
        try:
            ...
            if signInfoTopEle_woman != False:
                ...
                self.womandriver.find_element(*MultiWoman.sign_in_popover_reminderBtn).click()
    ...
    def test_homepage91(self):
        ...
        try:
            ...
            if my_Tasks_entryTwoText=='新奖励':
                ...
                assert MyTasks_tab_pointsNumberIcon==my_Tasks_entryTwoText11
                logging.info("===断言成功===")
    ...
    def test_homepage97(self):
        ...
        try:
            ...
            assert len(self.mandriver.find_elements(*MultiMan.MyTasks_tasks_signinSuccessID))!=0
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例106：我的任务-女-立即做任务按钮')
    def test_homepage106(self):
        logging.info("====我的任务-女-立即做任务按钮'===")
        try:
            self.multiwoman.tap(1061, 111)
            self.womandriver.find_element(*MultiWoman.MyTasks_tab_rewards).click()
            self.multiwoman.swipe(40, 1473, 40, 387, 100)
            ...
            logging.info('===断言失败===')
            screen_name = self.multiwoman.screenshot('我的任务-女-立即做任务按钮')
            logging.info(f'截图成功，图片为{screen_name}')
            raise
        except:
            logging.info("===执行失败===")
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例108：我的任务-女-签到入口')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例109：我的任务-女-每日任务')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例110：我的打招呼-男女入口显示-进入显示')
    def test_homepage110(self):
        ...
        try:
            ...
            if self.multiwoman.MyGrWords_faceVerification_popoverAllEle():
                ...
                # edit_contentText=self.womandriver.find_element(*MultiWoman.MyGrWords_edit_contentText)
                # edit_contentText.send_keys('hi,a nice day ,call me')
                ...
                self.womandriver.find_elements(*MultiMan.messages_Stranger_phonePictureListSelect)[0].click()
                time.sleep(2)
                self.womandriver.find_element(*MultiMan.messages_Stranger_phonePictureListConfirmBtn).click()
                time.sleep(2)
                edit_contentText = self.womandriver.find_element(*MultiWoman.MyGrWords_edit_contentText)
                edit_contentText.send_keys('hi,a nice day ,call me')
                self.womandriver.find_element(*MultiWoman.MyGrWords_edit_saveBtn).click()
                time.sleep(2)
                print(len(self.womandriver.find_elements(*MultiWoman.MyGrWords_edit_saveBannedTitle)))
                if len(self.womandriver.find_elements(*MultiWoman.MyGrWords_edit_saveBannedTitle))!=0 and 'is banned for' in self.womandriver.find_element(*MultiWoman.MyGrWords_edit_saveBannedTitle).text:
                    self.multiwoman.tap(954, 2268)
                    GrWords_woman = 404
                    pytest.skip('用户上传被禁止，跳过')
                else:
                    time.sleep(5)
                    GrWords_woman = 1
                    if len(self.womandriver.find_elements(*MultiWoman.myProfile_MyAvatar_ChangePosterFailedBtn))!=0:
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例111-112：我的打招呼-女-已通过真人检测')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例115：我的简介-男-头像-编辑')
    def test_homepage115(self):
        ...
        try:
            ...
            if self.multiman.get_permission_checkPopover():
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例116：我的简介-头像-男-无历史图集')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例118：我的简介-头像-女-有历史图集')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例119：我的简介-女-头像-编辑')
    def test_homepage119(self):
        ...
        try:
            ...
            self.womandriver.find_element(*MultiMan.messages_Stranger_phonePictureListConfirmBtn).click()
            time.sleep(2)
            self.womandriver.find_element(*MultiMan.myProfile_MyAvatar_ChangePosterUpdateConfirm).click()
            time.sleep(3)
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例122：我的简介-昵称-修改')
    def test_homepage122(self):
        logging.info("===我的简介-昵称-修改===")
        try:
            # newName='Tom33364388sss'
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例128-129：我的简介-定位切换')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例132-133：我的简介-第二语言显示和切换')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例135：我的简介-自我介绍修改')
    def test_homepage135(self):
        logging.info("===我的简介-自我介绍修改===")
        try:
            # newIntro='oh!happy every 1 dasss'
            # self.mandriver.find_element(*MultiMan.myProfile_SelfIntroduction_All).click()
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例136：我的简介-google弹窗')
    def test_homepage136(self):
        ...
        try:
            ...
            assert self.mandriver.find_element(*MultiMan.myProfile_Google_PopoverAccountAddText).text == '再添加一个账号'
            self.multiman.system_goback_key()
            logging.info("===断言成功===")
    ...
    def test_homepage138(self):
        ...
        try:
            ...
            if self.mandriver.find_element(*MultiMan.myProfile_Phone_ChangeTitle).text == '请验证原手机号':
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例140-141：我的简介-密码显示')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例142-143：我的余额-入口-我的钻石')
    def test_homepage142(self):
        ...
        try:
            ...
            assert myDiamondCount== entryDiamondNum_man
            ...
            assert myDiamondCount == entryDiamondNum_woman
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例144：我的余额-free入口')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例145：我的余额-Google档位')
    def test_homepage145(self):
        logging.info("===我的余额-Google档位===")
        try:
            global topUpType
            if len(self.mandriver.find_elements(*MultiMan.myBalance_TopUpTabTitle))==2:
                topUpType=1
                self.mandriver.find_elements(*MultiMan.myBalance_TopUpTabTitle)[0].click()
            ...
            logging.info('===断言失败===')
            screen_name = self.multiman.screenshot('我的余额-Google档位')
            logging.info(f'截图成功，图片为{screen_name}')
            raise
        except:
            logging.info("===执行失败===")
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例146：我的余额-Google档位-充值')
    def test_homepage146(self):
        logging.info("===我的余额-Google档位-充值===")
        try:
            ...
            logging.info('===断言失败===')
            screen_name = self.multiman.screenshot('我的余额-Google档位-充值')
            logging.info(f'截图成功，图片为{screen_name}')
            raise
        except:
            logging.info("===执行失败===")
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例147：我的余额-推荐充值或三方')
    def test_homepage147(self):
        logging.info("===我的余额-推荐充值或三方===")
        try:
            if topUpType==1:
                logging.info("===有推荐充值===")
                self.mandriver.find_elements(*MultiMan.myBalance_TopUpTabTitle)[1].click()
                assert len(self.mandriver.find_elements(*MultiMan.myBalance_TopUpList5Id)) == 6
                logging.info("===档位个数-断言成功===")
                self.multiman.swipe(578,1838,578,1214)
                if len(self.mandriver.find_elements(*MultiMan.myBalance_TopUpRecChangeBtn)) != 0:
                    self.mandriver.find_element(*MultiMan.myBalance_TopUpRecChangeBtn).click()
                    time.sleep(2)
                    selected_choose=self.mandriver.find_elements(*MultiMan.myBalance_TopUpRecChangePopSelected)[1]
                    assert selected_choose.get_attribute('selected')=='true'
                    self.multiman.system_goback_key()
                    logging.info("===更换按钮-断言成功===")
                self.mandriver.find_elements(*MultiMan.myBalance_TopUpList5Id)[0].click()
                assert self.mandriver.find_element(*MultiMan.myBalance_TopUpListNextCard)
                self.multiman.system_goback_key()
                logging.info("===充值跳转-断言成功===")
            else:
                logging.info("===无推荐充值===")
                if len(self.mandriver.find_elements(*MultiMan.myBalance_TopUpListmoreBtn))==0:
                    pytest.skip('该用户没有推荐充值和第三方充值')
                else:
            ...
            logging.info('===断言失败===')
            screen_name = self.multiman.screenshot('我的余额-推荐充值或三方')
            logging.info(f'截图成功，图片为{screen_name}')
            raise
        except:
            logging.info("===执行失败===")
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例151：我的页面-设置-APP语言')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例152：我的页面-设置-切换APP语言')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例153-154：我的页面-设置-黑名单')
    def test_homepage153(self):
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例155：我的页面-设置-隐私政策')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例156：我的页面-设置-用户协议')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例157：我的页面-设置-关于我们')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例158：我的页面-设置-关于我们删除账户')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例159：我的页面-设置-关于我们删除账户-提示弹窗')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例160：我的页面-设置-为Chamet评分')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例161：我的页面-设置-清除缓存')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例163：我的页面-设置-登出按钮')
    ...
    # @pytest.mark.skip(reason="本次不执行")
    @allure.severity(allure.severity_level.BLOCKER)
    @allure.title('用例164：我的页面-设置-登出按钮-登出')
...
if __name__ == '__main__':
    pytest.main([".\test_case\test_mypage_multi.py","-vs","--alluredir=..\result\mypage_result\2023_9_25_002"])
...
''' pytest .\test_mypage_multi.py -s -v --alluredir=..\result\mypage_result\2023_10_07_001'''
...
'''allure serve ..\result\mypage_result\2023_10_07_001'''
