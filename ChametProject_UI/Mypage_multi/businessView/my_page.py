...
class MyPage(Common):
    ...
    messages_Stranger_SendGiftBtn = (By.ID, 'com.hkfuliao.chamet:id/ll_send_gift')
    # 视频聊按钮状态
    ...
    level_specificNumberCss = (By.CSS_SELECTOR, '[class="vLevelFake"]')
    ...
    level_specificNumberleftCss = (By.CSS_SELECTOR,'[class="vlevel"]')
    ...
    level_TopUp_btn = (By.ID, 'leveltopbtn')

    # 我的收入
    MyBalance_entry = (By.XPATH,'/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ScrollView/android.widget.ScrollView/android.widget.LinearLayout/android.widget.RelativeLayout[8]/android.widget.TextView[1]')
    MyBalance_entry_RightClick = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ScrollView/android.widget.ScrollView/android.widget.LinearLayout/android.widget.RelativeLayout[8]/android.widget.TextView[2]')
    MyBalance_entry_withdrawText = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ScrollView/android.widget.ScrollView/android.widget.LinearLayout/android.widget.RelativeLayout[8]/android.widget.LinearLayout/android.widget.TextView')
    MyBalance_title_text = (By.ID, 'tixianmy')
    MyBalance_goback = (By.CLASS_NAME, 'go_back')
    MyBalance_earn_item = (By.CLASS_NAME, 'bd-detail-item bd-item-earning')
    MyBalance_wallet_item = (By.CLASS_NAME, 'bd-detail-item bd-cash-out')
    MyBalance_wallet_goback = (By.CLASS_NAME, 'hd-back-btn-div')
    MyBalance_withdraw_title = (By.CLASS_NAME, 'process-title')
    MyBalance_daily_report = (By.ID, 'Daily_Report')
    MyBalance_daily_reportRightClick = (By.CLASS_NAME, 'report-img')
    MyBalance_daily_reportGoback = (By.CLASS_NAME, 'iconfont icon-all_icon_back hd_back_img hd_top_back')
    MyBalance_earn_detail = (By.ID, 'bd-set-item earn-detail')
    MyBalance_myIncome_earnDetailText = (By.ID, 'Earning_Detail')
    MyBalance_myIncome_earnDetailGoback = (By.CLASS_NAME, 'go_back')
    MyBalance_settlement_detail = (By.CLASS_NAME, 'bd-set-item settlement-detail')
    MyBalance_settlement_detailText = (By.ID, 'tixiansettlement')
    MyBalance_settlement_detailGoback = (By.CLASS_NAME, 'go_back')
    MyBalance_contact_custom = (By.ID, 'lianxicustom')
    ...
    settings_blocklist_UserNameList = (By.ID,'com.hkfuliao.chamet:id/tv_country_name')
    settings_blocklist_UserClickList = (By.XPATH,'/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout')
    ...
    settings_PrivacyPolicy_titleXpath = (By.XPATH,"//*[@text='Introduction']")
    ...
    settings_UserAgreement_titleXpath = (By.XPATH, "//*[@text='User Agreement']")
    settings_UserAgreement_titleAndGoback = (By.ID, 'pricetlt')
    settings_UserAgreement_Welcome = (By.XPATH, "//*[@text='Welcome to CHAMET!']")
    ...
    MyInvite_instructionsBtn = (By.CLASS_NAME, 'info')
    MyInvite_instructionsPopover = (By.CLASS_NAME, 'close_pop_up rule_pop')
    MyInvite_instructionsPopover_rule1= (By.ID,'rule1')
    # 聊天卡免费用于视频聊天1分钟，每张卡有效期为5天
    # 只有新的Chamet用户才能获得奖励
    MyInvite_instructionsPopover_rule2 = (By.ID, 'rule2')



    MyInvite_goback = (By.CLASS_NAME, 'back')
    MyInvite_inviteFriendsBtn = (By.CLASS_NAME, 'i18n invite_friends')
    MyInvite_inviteFriendsBtnID = (By.ID, 'invite_friends')
    MyInvite_inviteFriendsPopover = (By.ID, 'com.hkfuliao.chamet:id/cardView3')
    MyInvite_myInvitees = (By.ID, 'my_invitees')
    ...
    MyInvite_weeklyRank = (By.ID, 'weekly_rank')
    MyInvite_weekly_noUser = (By.ID,'norecord')
    ...
    MyTasks_rewards_manLast6500NoClaim = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/androidx.viewpager.widget.ViewPager/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout/android.widget.LinearLayout/android.view.ViewGroup/android.widget.FrameLayout[1]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[6]/android.widget.LinearLayout/android.widget.FrameLayout[1]/android.widget.LinearLayout/android.widget.LinearLayout')
    ...
    myBalance_TopUp_moreBtn = (By.ID,'com.hkfuliao.chamet:id/iv_more_pic')
    ...
    # def get_permission_checkPopover(self):
    #     if self.Permission_popoverTitleEle() != False:
    #         self.driver.find_element(*MyPage.Permission_popoverConfirmBtn).click()


    # def system_getPermission_checkPopover(self):
    #     if self.Permission_85Phone_PopoverTitleEle() != False:
    #         self.driver.find_element(*MyPage.Permission_85Phone_PopoverConfirmBtn).click()
    ...
    def messages_entry_UnReadNumIDEle(self):
        ...
        try:
            ...
            return messages_entry_UnReadNumID111
    ...
    def userHalfPagePopoverNameOrOneselfEle(self):
        try:
            if self.userHalfPagePopoverGiftSendBtnEle():
    ...
    def userHalfPagePopoverImgListEle_onebyone(self):
        len_num = len(self.driver.find_elements(*MyPage.messages_Group_upMicUserHeadList))
        for i in range(len_num):
            self.driver.find_elements(*MyPage.messages_Group_upMicUserHeadList)[i].click()
    ...
    def messages_Group_diamondsPacketStatusExpiredEle(self):
        logging.info('===留言-群聊-群聊钻石包状态-已过期===')
        try:
    ...
    def messages_Group_MoreMomentAllEle(self):
        logging.info('===动态整个元素===')
        try:
            self.driver.find_elements(*self.messages_Group_MoreMomentAll)
        except NoSuchElementException:
    ...
    def vip_Level_right_click(self):
        ...
        try:
            my_vipLevel_entryRightClick = self.driver.find_element(*self.my_vipLevel_entryRightClick)
        except NoSuchElementException:
            logging.info('no my_vipLevel_entryRightClick')
        else:
            my_vipLevel_entryRightClick.click()
            time.sleep(10)
            #进入h5界面后，获取上下文，并切换至h5
            Common.native_to_h5(self)

    '''查找等级外部显示lvx,主要为女用户和男用户lv0'''
    ...
    def vipLevel_level_value(self):
        try:
            ll = self.driver.find_elements(*self.level_specificNumber)[0].text
        except NoSuchElementException:
    ...
    def vipLevel_levelLeft_value(self):
        try:
            ll = self.driver.find_elements(*self.level_specificNumberleft)[0].text
        except NoSuchElementException:
            logging.info('no level_title')
            return False
        else:
    ...
    def vip_Level_mylevel_goback(self):
        try:
            ll = self.driver.find_elements(*self.level_goback)
        except NoSuchElementException:
            logging.info('no level_title')
        else:
            print(ll)
    ...
    def MyTasks_rewards_CongratsPopoverAwesomeBtnEle(self):
        try:
            MyTasks_rewards_CongratsPopoverAwesomeBtn = self.driver.find_element(*self.MyTasks_rewards_CongratsPopoverAwesomeBtn)
    ...
    def MyTasks_rewards_RewardDetailsPopoverOkBtnEle(self):
        try:
            MyTasks_rewards_RewardDetailsPopoverOkBtn = self.driver.find_element(*self.MyTasks_rewards_RewardDetailsPopoverOkBtn)
