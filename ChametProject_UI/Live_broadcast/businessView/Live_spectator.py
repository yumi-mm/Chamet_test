...
class Live_spectator(Common):
    ...
    tab_party_follow = (By.XPATH, '//android.widget.LinearLayout[@content-desc="关注"]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.TextView')
    ...
    my_group = (By.ID, 'com.hkfuliao.chamet:id/ivMyGroup')
    my_group_one = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout[1]/android.widget.RelativeLayout')
    my_group_back = (By.ID, 'com.hkfuliao.chamet:id/back')
    ...
    sticker_download = (By.XPATH,
                        ...
                        '.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.ImageView[2]')
    sticker_downloading = (By.ID, 'com.hkfuliao.chamet:id/progress')
    ...
    more_Setting_background_Lv20 = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout'
                                              '/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.RelativeLayout/android.widget.ImageView[1]')
    ...
    more_setting_sticker_1download = (By.XPATH,
                                      '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.ImageView')
    ...
    six_party_four_gift = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.view.ViewGroup/android.widget.LinearLayout/androidx.viewpager.widget.ViewPager/android.widget.LinearLayout/androidx.viewpager.widget.ViewPager/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[4]')

    six_party_gift_single = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout/android.view.ViewGroup[2]/android.widget.LinearLayout/android.widget.LinearLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]')
    ...
    six_party_more_people_list_two = (By.XPATH,
                                      '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.viewpager.widget.ViewPager/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ImageView[2]')
    six_party_supernatant_dynamic = (By.ID, 'com.hkfuliao.chamet:id/iv_user_head')
    ...
    myphoto_one = (By.XPATH,
                   '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.ImageView')
    myphoto_confirm = (By.ID, 'com.hkfuliao.chamet:id/menu_id_confirm')
    supernatant_message_setting_photo_confirm = (By.ID, 'com.android.camera:id/v9_shutter_button_internal')
    ...
    six_message_user = (By.XPATH,
                        '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.TextView')
    ...
    live_anchor_avatar = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ImageView[2]')
    live_superposed_trends_two = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.LinearLayout[2]/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.RelativeLayout[2]/android.widget.ImageView')
    trends_likes = (By.ID, 'com.hkfuliao.chamet:id/ivZan_unSelect')
    trends_likes_success = (By.ID, 'com.hkfuliao.chamet:id/ivZan_select')
    trends_gift = (By.ID, 'com.hkfuliao.chamet:id/iv_gift_select')
    trends_review = (By.ID, 'com.hkfuliao.chamet:id/ivComment')
    trends_review_commend = (By.ID, 'com.hkfuliao.chamet:id/tv_comment_content')
    trends_review_commend_edit = (By.ID, 'com.hkfuliao.chamet:id/edit_comment')
    trends_review_commend_send = (By.ID, 'com.hkfuliao.chamet:id/iv_send_comment')
    trends_review_records = (By.ID, 'com.hkfuliao.chamet:id/ll_comment_detail')
    trends_Share = (By.ID, 'com.hkfuliao.chamet:id/ivMore')
    trends_call = (By.ID, 'com.hkfuliao.chamet:id/rl_call')
    trends_calling = (By.ID, 'com.hkfuliao.chamet:id/svg_call_status')
    live_call = (By.ID, 'com.hkfuliao.chamet:id/call')
    live_guide_call = (By.ID, 'com.hkfuliao.chamet:id/callBtn')
    call_stop = (By.ID, 'com.hkfuliao.chamet:id/iv_stop_call')
    live_vermicelli_top = (By.ID, 'com.hkfuliao.chamet:id/cl_top_fan_content')
    live_vermicelli_top_title = (By.ID, 'com.hkfuliao.chamet:id/ll_title')
    live_vermicelli_top_one_people = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout/android.view.ViewGroup[2]/android.widget.FrameLayout[1]/android.view.ViewGroup/android.widget.ImageView[2]')
    ...
    test_expect025 = (By.ID, 'com.hkfuliao.chamet:id/iv_pic')
    ...
    test_expect040 = (By.ID, 'com.hkfuliao.chamet:id/giftPicIv')
    ...
    test_expect042 = (By.XPATH,
                      '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]')
    test_expect044 = (By.XPATH, '//android.widget.TextView[contains(@text, "[level]  Hello123456 : @User20111243")]')
    ...
    test_expect067 = (By.XPATH, '//android.widget.TextView[contains(@text, "[level]  User20111243 加入了房间")]')
    test_expect068 = (By.ID, 'com.hkfuliao.chamet:id/rl_send_message')
    ...
    test_expect074 = (By.XPATH,
                      '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.RelativeLayout/android.widget.ImageView[2]')
    ...
    test_expect102 = (By.XPATH, '//android.widget.TextView[contains(@text, "[level] goodbay1 加入了房间")]')
    test_expect103 = (By.ID, 'com.hkfuliao.chamet:id/img_love')
    test_expect116 = (By.XPATH,
                      '//android.widget.TextView[contains(@text, "欢迎来到Chamet 交友房！警告：直播期间严禁出现色情、粗俗、暴力、未成年人等相关情况。人工智能系统每天24 小时对其进行审查。一旦违反规定，将受到严惩！")]')
    test_expect117 = (By.XPATH, '//android.widget.TextView[contains(@text, "[level] goodbay1 : 1234")]')
    ...
    test_expect135 = (By.XPATH, '//android.widget.TextView[contains(@text, "21")]')
    ...
    test_expect101 = (By.ID, 'com.hkfuliao.chamet:id/lrv_host_1')
    test_expect32 = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.widget.FrameLayout[1]')
    test_expect41 = (By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.RelativeLayout/android.view.ViewGroup/android.widget.FrameLayout[1]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.ImageView')
    test_expect8 = (By.XPATH, '//android.widget.TextView[contains(@text, "[level] goodbay1 加入了房间")]')
    ...
    def Tab_party_follow(self):
        logging.info('=交友房Tab页-follow栏目点击=')
        try:
            tab_party_follow = self.driver.find_element(*self.tab_party_follow)
        except NoSuchElementException:
            logging.info('=未找到交友房Tab页-follow栏目=')
        else:
            tab_party_follow.click()
    ...
    def My_group(self):
        logging.info('=我的群聊列表点击=')
        try:
            my_group = self.driver.find_element(*self.my_group)
        except NoSuchElementException:
            logging.info('=未找到我的群聊列表按钮=')
        else:
            my_group.click()

    def My_group_one(self):
        logging.info('=我的群聊列表点击进入第一个群聊=')
        try:
            my_group_one = self.driver.find_element(*self.my_group_one)
        except NoSuchElementException:
            logging.info('=未找到我的群聊列表第一个群聊=')
        else:
            my_group_one.click()

    def My_group_back(self):
        logging.info('=我的群聊列表返回按钮=')
        try:
            my_group_back = self.driver.find_element(*self.my_group_back)
        except NoSuchElementException:
            logging.info('=未找到我的群聊返回按钮=')
        else:
            my_group_back.click()

    def Trends_back(self):
        logging.info('=动态返回按钮=')
        try:
            my_group_back = self.driver.find_element(*self.my_group_back)
        except NoSuchElementException:
            logging.info('=未找到动态返回按钮=')
        else:
            my_group_back.click()
    ...
    def Six_party_four_gift(self):
        logging.info('=点击礼物橱窗的第四个礼物=')
        try:
            six_party_four_gift = self.find_element(*self.six_party_four_gift)
        except NoSuchElementException:
            logging.info('=未找到礼物橱窗的第四个礼物=')
        else:
            six_party_four_gift.click()
    ...
    def Group_more(self):
        logging.info('=点击全屏群聊更多按钮=')
        try:
            group_more = self.find_element(*self.group_more)
        except NoSuchElementException:
            logging.info('=未找到全屏群聊更多按钮=')
        else:
            group_more.click()

    def Group_more_two_people(self):
        logging.info('=点击群聊更多中-第二个群成员=')
        try:
            group_more_two_people = self.find_element(*self.group_more_two_people)
        except NoSuchElementException:
            logging.info('=未找到群聊更多中-第二个群成员=')
        else:
            group_more_two_people.click()
    ...
    def Live_anchor_avatar(self):
        logging.info('=观众点击直播间房主头像=')
        try:
            live_anchor_avatar = self.find_element(*self.live_anchor_avatar)
        except NoSuchElementException:
            logging.info('=观众未找到直播间房主头像=')
        else:
            live_anchor_avatar.click()

    def Live_superposed_trends_two(self):
        logging.info('=观众点击主播信息浮层-第二个动态=')
        try:
            live_superposed_trends_two = self.find_element(*self.live_superposed_trends_two)
        except NoSuchElementException:
            logging.info('=观众未找到主播信息浮层-第二个动态=')
        else:
            live_superposed_trends_two.click()

    def Trends_likes(self):
        logging.info('=动态-点赞=')
        try:
            trends_likes = self.find_element(*self.trends_likes)
        except NoSuchElementException:
            logging.info('=未找到动态-点赞按钮=')
        else:
            trends_likes.click()

    def Trends_gift(self):
        logging.info('=动态-送礼=')
        try:
            trends_gift = self.find_element(*self.trends_gift)
        except NoSuchElementException:
            logging.info('=未找到动态-送礼按钮=')
        else:
            trends_gift.click()

    def Trends_review(self):
        logging.info('=动态-评论=')
        try:
            trends_review = self.find_element(*self.trends_review)
        except NoSuchElementException:
            logging.info('=未找到动态-评论按钮=')
        else:
            trends_review.click()

    def Trends_review_commend(self):
        logging.info('=动态-准备评论点击输入框=')
        try:
            trends_review_commend = self.find_element(*self.trends_review_commend)
        except NoSuchElementException:
            logging.info('=未找到动态-准备评论输入框=')
        else:
            trends_review_commend.click()

    def Trends_review_commend_edit(self):
        logging.info('=动态-评论-输入=')
        try:
            trends_review_commend_edit = self.find_element(*self.trends_review_commend_edit)
        except NoSuchElementException:
            logging.info('=未找到动态-评论输入框=')
        else:
            trends_review_commend_edit.send_keys('1234')

    def Trends_review_commend_send(self):
        logging.info('=动态-评论-发送=')
        try:
            trends_review_commend_send = self.find_element(*self.trends_review_commend_send)
        except NoSuchElementException:
            logging.info('=未找到动态-评论-发送按钮=')
        else:
            trends_review_commend_send.click()
    def Trends_Share(self):
        logging.info('=动态-分享=')
        try:
            trends_Share = self.find_element(*self.trends_Share)
        except NoSuchElementException:
            logging.info('=未找到动态-分享按钮=')
        else:
            trends_Share.click()

    def Trends_call(self):
        logging.info('=动态-拨打=')
        try:
            trends_call = self.find_element(*self.trends_call)
        except NoSuchElementException:
            logging.info('=未找到动态-拨打按钮=')
        else:
            trends_call.click()
    ...
    def Live_call(self):
        logging.info('=直播间-拨打=')
        try:
            live_call = self.find_element(*self.live_call)
        except NoSuchElementException:
            logging.info('=未找到直播间-拨打按钮=')
        else:
            live_call.click()

    def Live_guide_call(self):
        logging.info('=直播间-引导拨打=')
        try:
            live_guide_call = self.find_element(*self.live_guide_call)
        except NoSuchElementException:
            logging.info('=未找到直播间-引导拨打按钮=')
        else:
            live_guide_call.click()

    def Call_stop(self):
        logging.info('=浮层中取消拨打=')
        try:
            call_stop = self.find_element(*self.call_stop)
        except NoSuchElementException:
            logging.info('=未找到浮层中取消拨打按钮=')
        else:
            call_stop.click()

    def Live_vermicelli_top(self):
        logging.info('=直播间粉丝帮=')
        try:
            live_vermicelli_top = self.find_element(*self.live_vermicelli_top)
        except NoSuchElementException:
            logging.info('=未找到直播间粉丝榜按钮=')
        else:
            live_vermicelli_top.click()

    def Live_vermicelli_top_one_people(self):
        logging.info('=直播间粉丝帮内第一个用户=')
        try:
            live_vermicelli_top_one_people = self.find_element(*self.live_vermicelli_top_one_people)
        except NoSuchElementException:
            logging.info('=未找到直播间粉丝榜内第一个用户=')
        else:
            live_vermicelli_top_one_people.click()
###############################################################################################################################################################################################################################################################################################################
    # 点击创建交友房时判断右上角出现 × 按钮
    ...
    def Test_10(self):
        logging.info('=判断能否进入主播个人主页=')
        try:
            self.driver.find_element(*self.test_expect011)
        except NoSuchElementException:
            logging.info('=不能进入主播个人主页=')
            return False
        else:
            logging.info('=进入主播个人主页=')
            return True
    ...
    def Test_X013(self):
        ...
        try:
            self.driver.find_element(*self.test_expect013)
        except NoSuchElementException:
    ...
    def Test_14_1(self):
        logging.info('=判断信息浮层有无送礼按钮=')
        try:
            self.driver.find_element(*self.six_party_supernatant_gift)
        except NoSuchElementException:
            logging.info('=无送礼按钮=')
            return False
        else:
    ...
    def Test_14_2(self):
        logging.info('=判断信息浮层有无拨打按钮=')
        try:
            self.driver.find_element(*self.six_party_call_anchor)
        except NoSuchElementException:
            logging.info('=无拨打按钮=')
            return False
        else:
    ...
    def Test_19(self):
        logging.info('=判断是否进入动态大图模式=')
        try:
            self.driver.find_element(*self.trends_likes)
        except NoSuchElementException:
            logging.info('=未进入动态大图模式=')
            return False
        else:
            logging.info('=进入动态大图模式=')
            return True
    ...
    def Test_20(self):
        ...
        try:
            self.driver.find_element(*self.trends_gift)
        except NoSuchElementException:
            logging.info('=未送礼成功=')
            return False
        else:
    ...
    def Test_21(self):
        logging.info('=判断是否点赞成功=')
        try:
            self.driver.find_element(*self.trends_likes_success)
        except NoSuchElementException:
            logging.info('=未点赞成功=')
            return False
        else:
    ...
    def Test_22(self):
        logging.info('=判断是否评论成功=')
        try:
            self.driver.find_element(*self.trends_review_records)
        except NoSuchElementException:
            logging.info('=未评论成功=')
            return False
        else:
    ...
    def Test_23(self):
        ...
        try:
            self.driver.find_element(*self.trends_calling)
        except NoSuchElementException:
            logging.info('=拨打成功=')
            return False
        else:
    ...
    def Test_24(self):
        logging.info('=判断浮层是否是打开状态=')
        try:
            self.driver.find_element(*self.test_expect017)
        except NoSuchElementException:
            logging.info('=浮层不是打开状态=')
            return False
        else:
            logging.info('=浮层是打开状态=')
            return True

    def Test_26(self):
        logging.info('=判断是否出现拨打小浮层=')
        try:
            self.driver.find_element(*self.call_stop)
        except NoSuchElementException:
            logging.info('=未出现拨打小浮层=')
            return False
        else:
            logging.info('=出现了拨打小浮层=')
            return True

    def Test_31(self):
        logging.info('=判断是否打开粉丝榜=')
        try:
            self.driver.find_element(*self.live_vermicelli_top_title)
        except NoSuchElementException:
            logging.info('=未打开粉丝榜=')
            return False
        else:
    ...
    def Test_32(self):
        logging.info('=判断是否弹出充值浮层=')
        try:
            self.driver.find_element(*self.test_expect32)
        except NoSuchElementException:
            logging.info('=未弹出充值浮层=')
            return False
        else:
            logging.info('=弹出充值浮层=')
            return True
    ...
    def Test_X068(self):
        ...
        try:
            self.driver.find_element(*self.test_expect068)
        except NoSuchElementException:
            logging.info('=没有信息浮层=')
            return False
        else:
    ...
    def Test_X135(self):
        logging.info('=判断收礼榜是否有数据=')
        try:
            self.driver.find_element(*self.test_expect135)
        except NoSuchElementException:
            logging.info('=收礼榜无数据=')
            return False
        else:
    ...
    def Test_X100(self):
        logging.info('=判断嘉宾是否收到了邀请弹窗=')
        try:
            self.driver.find_element(*self.test_expect157)
        except NoSuchElementException:
            logging.info('=没有收到邀请弹窗=')
            return False
        else:
            logging.info('=收到了邀请弹窗=')
            return True
    ...
    def Test_8(self):
        logging.info('=判断是否有无进场提示=')
        try:
            self.driver.find_element(*self.test_expect8)
        except NoSuchElementException:
            logging.info('=没有进场提示=')
            return False
        else:
    ...
    def Test_101(self):
        logging.info('=判断嘉宾是否上麦=')
        try:
            self.driver.find_element(*self.test_expect101)
        except NoSuchElementException:
            logging.info('=没有上麦=')
            return False
        else:
    ...
    def Test_102(self):
        logging.info('=判断嘉宾是否上麦=')
        try:
            self.driver.find_element(*self.more_join)
        except NoSuchElementException:
            logging.info('=上麦成功=')
            return False
        else:
    ...
    def Test_100(self):
        logging.info('=判断观众是否收到上麦邀请=')
        try:
            self.driver.find_element(*self.six_party_agree_invite)
        except NoSuchElementException:
            logging.info('=没有收到=')
            return True
        else:
...
if __name__ == '__main__':
    driver = spectator_appium_desired()
    S = Live_spectator(driver)
    S.Tab_party()
    S.Setup_party()
    S.Setup_six_party()
    S.Two_Setup()
