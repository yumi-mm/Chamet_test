...
class Six_partyView_spectator(Common):
    ...
    supernatant_message_group = (By.ID, 'com.hkfuliao.chamet:id/groupIv')
    ...
    test_expect135 = (By.XPATH, '//android.widget.TextView[contains(@text, "60.0K")]')
    ...
    def Supernatant_message_group_packet_number(self):
        ...
        try:
            ...
            supernatant_message_group_packet_number.send_keys('3')
    ...
    def Supernatant_message_group_packet_diamond(self):
        ...
        try:
            ...
            supernatant_message_group_packet_diamond.send_keys('2000')
...
###############################################################################################################################################################################################################################################################################################################
    ...
    def Test_X037(self):
        ...
        try:
            self.driver.find_element(*self.supernatant_message_group_addvoice)
        except NoSuchElementException:
            logging.info('=没有上麦=')
            return False
        else:
